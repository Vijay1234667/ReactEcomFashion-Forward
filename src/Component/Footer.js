                    ...
                    <div className="row footer-top">
                        <div className="col-lg-3 col-md-6 mb-4">
                            <div className="footer-left-sec">
                                <img className="img-fluid d-block m-auto mb-3" src="https://ik.imagekit.io/gku4adhog/first-fly-travel/Delta.svg?updatedAt=1714385080148" alt="shopimage" width="160px"
                                    height="200px" />
                                <p className="text-center">
                                    consectetur adipisicing elit. Laudantium fugit, sunt tenetur qui
                                    .
                                </p>
                            ...
                            <div className="row">
                                <div className="col-lg-6 col-6 footer-column-links">
                                    <ul className="nav flex-column">
                                        ...
                                        <li className="nav-item">
                                            <Link className="nav-link active" to="categories">Category</Link>
                                        </li>
                                        <li className="nav-item">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 col-12 ">
                            ...
                            <div className="footer-column-links-tags">
                                ...
                                <Link to="paymentsuccessfull">successfull</Link>
                                <Link to="addtocart">NEW</Link>
                                <Link to="filtercategory">WIRELESS</Link>
                                <a href="/">CABLES</a>
                                <a href="/"> BRANDS</a>
                                <a href="/">CASES</a>
                                <a href="/"> CABLES</a>
